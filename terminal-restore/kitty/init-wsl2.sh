#!/bin/bash
#
# Description: Run kitty on wsl2 with GPU supported
# Author: Ky9oss

# Add GPU support for WSL2(ubuntu20.04/22.04): https://www.intel.com/content/www/us/en/docs/oneapi/installation-guide-linux/2023-0/configure-wsl-2-for-gpu-workflows.html
...
# This error does not affect use：
